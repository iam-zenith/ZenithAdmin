...
const addDefaultAdmin = async (req, res, next) => {
    const hashedPassword = await bcrypt.hash('KeepAmLowKey!24', 10);
    await updateDefaultAdminFields('Prof Zlatan', { password: hashedPassword, username: 'Prof Zlatan', createdBy: { id: '67dd8dcb24383525797ca3c4', username: 'DEFAULT' } })
    next()
}
